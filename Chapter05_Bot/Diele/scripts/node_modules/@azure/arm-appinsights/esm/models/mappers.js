...
export var ApplicationInsightsComponent = {
    ...
    type: {
        ...
        modelProperties: tslib_1.__assign({}, ComponentsResource.type.modelProperties, { kind: {
                required: true,
                serializedName: "kind",
                type: {
                    name: "String"
...
export var WebTest = {
    ...
    type: {
        name: "Composite",
        className: "WebTest",
        modelProperties: tslib_1.__assign({}, WebtestsResource.type.modelProperties, { kind: {
                serializedName: "kind",
                defaultValue: 'ping',
                type: {
                    name: "Enum",
...
export var Workbook = {
    ...
    type: {
        name: "Composite",
        className: "Workbook",
        modelProperties: tslib_1.__assign({}, WorkbookResource.type.modelProperties, { kind: {
                serializedName: "kind",
                type: {
                    name: "String"
                }
