...
var createOrUpdateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.ResourceGroup), { required: true })
    },
    responses: {
        200: {
...
var updateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.ResourceGroupPatchable), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ResourceGroup
...
var exportTemplateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.ExportTemplateRequest), { required: true })
    },
    responses: {
        200: {
